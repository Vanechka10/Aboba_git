...
def question(message):
    ...
    with open('images/answer.txt', encoding='utf=8') as f:
        l=f.read()
...
def exit(message):
    bot.send_sticker(message.chat.id, "CAACAgIAAxkBAAEEZDBiTZWTemH11YYC17XAtKnwWR9xYQAC9wAD9wLID9CX3j-K0TwOIwQ")
